...
class ExploreBrandsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ai Phone - Global Brands'),
        actions: [
          IconButton(
          ...
          children: [
            TextField(
              decoration: InputDecoration(
                hintText: 'Search any smartphone or specs with AI...',
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Select devices to compare side by side',
...
// 3. Used Market Screen (مع شروط الدولة، الـ 1 دولار، وإثبات الهوية المشفر)
...
class _UsedMarketScreenState extends State<UsedMarketScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Used Market ($selectedCountry Residents)'),
        actions: [
          IconButton(
            icon: const Icon(Icons.add_circle, color: Colors.orangeAccent),
            tooltip: 'Sell Your Phone',
            onPressed: () => _showSellPhoneModal(context),
          ),
        ],
      ),
      body: Column(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'iPhone 14 Pro Max (Item #${index + 1})',
                              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                            ),
                            const Chip(
                              label: Text('Verified ID', style: TextStyle(fontSize: 10)),
                        ...
                        const Text(
                          'Specs: Mint condition, battery health 90%, original box included.',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () => _showUnlockPriceDialog(context),
  ...
  void _showUnlockPriceDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Unlock Price', style: TextStyle(color: Colors.orangeAccent)),
        content: const Text(
          'A fee of \$1 applies to reveal the exact price and connect securely with the seller.',
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Unlocked! Price: \$700')),
              );
            },
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const TextField(decoration: InputDecoration(labelText: 'Phone Specs & Condition')),
              ...
              Container(
                ...
                child: const Text(
                  'Anti-Fraud Security: Mandatory ID upload required. ID remains encrypted and hidden from buyers, accessible only by legal authorities if requested.',
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('ID Verified Securely.')),
                  );
                },
                icon: const Icon(Icons.upload_file, color: Colors.orange),
                label: const Text('Upload Secure ID'),
              ),
            ],
          ),
        ),
...
class NewsAndVideosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('News & Media Reviews')),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Global Tech Review & Video #${index + 1}',
                        style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                      ),
                      const SizedBox(height: 6),
                      const Text(
...
// 5. Settings Screen (25 Global Languages)
      ...
      body: ListView(
        children: [
          ValueListenableBuilder<String>(
            ...
            builder: (context, lang, child) {
              return ListTile(
                ...
                title: const Text('Languages (Top 25)'),
          ...
          const ListTile(
            ...
            subtitle: Text('Synced with global sources'),
          ),
          const ListTile(
