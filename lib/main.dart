...
// نظام الترجمة الشامل لجميع الـ 25 لغة بدون أي نقص
String getAppText(String langCode, String key) {
  Map<String, Map<String, String>> dictionary = {
    ...
    'pt': {
      'subtitle': 'Base de dados global de telefones e especificações',
      'signin': 'Entrar',
      'guest': 'Continuar como Convidado',
      'dbTitle': 'Base de Dados de Telefones',
      'marketTitle': 'Mercado de Usados (1\$)',
      'searchHint': 'Pesquisar telefone ou marca...',
      'priceLabel': 'Preço:',
      'closeSpecs': 'Fechar Especificações',
      'marketBanner': 'Pague apenas \$1.00 para revelar os contatos do vendedor.',
      'unlockBtn': 'Pagar \$1.00 para Desbloquear',
      'exitTitle': 'Sair do Aplicativo',
      'exitMsg': 'Tem certeza de que deseja sair?',
      'cancel': 'Cancelar',
      'confirmExit': 'Sair',
    ...
    'fr': {
      ...
      'searchHint': 'Rechercher un téléphone...',
      'priceLabel': 'Prix:',
      'closeSpecs': 'Fermer',
    ...
    'de': {
      ...
      'marketBanner': 'Zahlen Sie nur \$1.00, um die Kontaktdaten anzuzeigen.',
    ...
    'it': {
      'subtitle': 'Database globale di telefoni e specifiche',
      'signin': 'Accedi',
      'guest': 'Continua come ospite',
      'dbTitle': 'Database Telefoni',
      'marketTitle': 'Mercato usato (1\$)',
      'searchHint': 'Cerca telefono...',
      'priceLabel': 'Prezzo:',
      'closeSpecs': 'Chiudi',
      'marketBanner': 'Paga \$1.00 per sbloccare il contatto.',
      'unlockBtn': 'Paga \$1.00',
      'exitTitle': 'Esci',
      'exitMsg': 'Vuoi uscire?',
      'cancel': 'Annulla',
    ...
    'ru': {
      'subtitle': 'Глобальная база данных телефонов',
      'signin': 'Войти',
      'guest': 'Гость',
      'dbTitle': 'База данных',
      'marketTitle': 'Рынок б/у (1\$)',
      'searchHint': 'Поиск телефона...',
      'priceLabel': 'Цена:',
      'closeSpecs': 'Закрыть',
      'marketBanner': 'Оплатите \$1.00 для просмотра контактов.',
      'unlockBtn': 'Оплатить \$1.00',
      'exitTitle': 'Выход',
      'exitMsg': 'Выйти из приложения?',
      'cancel': 'Отмена',
      'confirmExit': 'Выход',
      'processor': 'Процессор:',
      'screen': 'Экран:',
    ...
    'zh': {
      ...
      'priceLabel': '价格:',
      'closeSpecs': '关闭',
      'marketBanner': '仅需支付 \$1.00 即可查看卖家联系方式。',
      'unlockBtn': '支付 \$1.00 解锁',
      'exitTitle': '退出应用',
      'exitMsg': '您确定要退出吗？',
      'cancel': '取消',
      'confirmExit': '退出',
    ...
    'tr': {
      'subtitle': 'Küresel Telefon Veritabanı ve Performans Özellikleri',
      'signin': 'Giriş Yap',
      'guest': 'Misafir',
      'dbTitle': 'Telefon Veritabanı',
      'marketTitle': 'İkinci El Pazarı (1\$)',
      'searchHint': 'Telefon veya marka ara...',
      'priceLabel': 'Fiyat:',
      'closeSpecs': 'Kapat',
      'marketBanner': 'Satıcı iletişim bilgilerini görmek için \$1.00 ödeyin.',
      'unlockBtn': 'Kilidi Aç (\$1.00)',
      'exitTitle': 'Çıkış',
  ...
  // إذا كانت اللغة المحددة غير موجودة حرفياً، يتم استخدام الترجمة المتاحة أو الإنجليزية كاحتياطي
