...
class _AiPhoneStoreAppState extends State<AiPhoneStoreApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // الوضع الفاتح بتصميم عالمي فاخر
      theme: ThemeData(
        useMaterial3: true,
        fontFamily: 'Cairo',
...
class NewPhonesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text(_t('title'), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
        centerTitle: true,
        actions: [
          IconButton(
      ...
      body: ListView(
        ...
        children: [
          // المربع الأزرق التفاعلي الفعال بالكامل
          Material(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.cloud_sync_rounded, color: Colors.white, size: 34),
...
class UsedPhonesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text(currentLang == 'ar' ? 'سوق الهواتف المستعملة' : 'Used Phones Market', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
        centerTitle: true,
      ),
      body: ListView(
        padding: const EdgeInsets.all(16),
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.lock_person_rounded, color: Colors.amber.shade700, size: 28),
