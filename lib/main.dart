                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          String userQuery = promptController.text.trim();
                          if (userQuery.isEmpty) userQuery = "أمر قياسي عام";
                          ...
                          Future.delayed(const Duration(milliseconds: 900), () {
                            setStateModal(() {
                              isLoading = false;
                              isCompleted = true;
                              resultText = "✨ تمت بنجاح استجابة محرك ($engineTitle) للأمر:\n«$userQuery»\n\n• تم توليد المحتوى الذكي بدقة واحترافية!";
                            });
                          });
                        },
                        child: isLoading
                    ...
                    if (isCompleted) ...[
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(resultText, style: const TextStyle(color: Colors.white, fontSize: 14)),
