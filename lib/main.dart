...
// خريطة الترجمات الشاملة للـ 25 لغة المدعومة في LifePilot OS
...
class HomeScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Select Language / تغيير اللغة',
          ),
        ],
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // شبكة الأيقونات الأربع مع الترجمة الفورية الكاملة
            Expanded(
  ...
  Widget _buildEngineCard({
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: const LibraryColorCardFallback(0xFF1A1C24),
...
class LibraryColorCardFallback extends Color {
  const LibraryColorCardFallback(int value) : super(value);
}
