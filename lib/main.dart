...
// ==========================================
// شاشة الترحيب الخارجية (مع نظام الترجمة الشامل للـ 25 لغة)
// ==========================================
class WelcomeAuthScreen extends StatelessWidget {
  ...
  // قائمة الـ 25 لغة العالمية المتداولة
  ...
  // قاموس الترجمة الشامل لجميع اللغات المدعومة
  String _getWelcomeText(String key) {
    Map<String, Map<String, String>> dictionary = {
      ...
      'ru': {
        'subtitle': 'Глобальная база данных телефонов и спецификации',
        'signin': 'Войти',
      ...
      'ja': {
        'subtitle': 'グローバルスマートフォンデータベースと仕様',
        'signin': 'サインイン',
        'guest': 'ゲストとして続行',
      },
      'tr': {
    ...
    // إذا كانت اللغة المختارة موجودة في القاموس يتم جلبها، وإلا يتم جلب الإنجليزية كافتراضي آمن
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                // أزرار التحكم العلوي (الإضاءة واللغات)
                Row(
                  ...
                  children: [
                    ...
                    // قائمة اللغات مع علامة الصح ✔️ وتفعيل الاختيار الفوري
                    Container(
                      decoration: BoxDecoration(color: Colors.white.withOpacity(0.15), shape: BoxShape.circle),
                            ...
                            return PopupMenuItem<String>(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (isSelected)
                                    const Icon(Icons.check_circle, color: Color(0xFF1E3A8A), size: 18),
                                ],
                              ),
                            );
                          }).toList();
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(_getWelcomeText('signin'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    child: Text(_getWelcomeText('guest'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
