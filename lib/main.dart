...
class AppState extends ChangeNotifier {
  ...
  final List<PhoneModel> globalPhonesDatabase = [
    ...
    PhoneModel(
      ...
      specsAr: 'معالج ميديا تك ديمنسيتي 8200 | كاميرا 50 ميجابكسل | شحن سريع 80 واط',
      aiVerdictEn: 'Sleek design with professional portrait modes for everyday users.',
      aiVerdictAr: 'تصميم أنيق مع وضعيات بورتريه احترافية.',
...
void showLanguageDialog(BuildContext context) {
  ...
  final languages = {'en': 'English (Default)', 'ar': 'العربية (Arabic)'};
