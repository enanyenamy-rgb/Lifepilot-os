...
class AppState extends ChangeNotifier {
  ...
  // قاعدة بيانات ضخمة وشاملة لكل الماركات العالمية (سامسونج، آبل، أوبو، شاومي، وغيرها)
  ...
  final Map<String, Map<String, String>> translations = {
    ...
    'ar': {
      ...
      'searchHint': 'ابحث عن أي علامة تجارية أو موديل (مثل Oppo)...',
...
class GlobalCatalogsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // محرك البحث الذكي: يبحث في القائمة أو يولد الهاتف تلقائياً إن لم يوجد ليعطي نتيجة ذكية
    ...
    // خاصية البحث الذكي المباشر (Smart AI Discovery Fallback)
    if (filteredPhones.isEmpty && appState.searchQuery.isNotEmpty) {
      filteredPhones = [
        PhoneModel(
          ...
          brand: 'Global Brand',
          price: '\$699',
          specs: 'Dynamic Global Specs | High-Resolution Display | Advanced Processor | Fast Charging Support',
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(item.phoneName, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold, name: Colors.white) as Widget?,), // Fix typo
