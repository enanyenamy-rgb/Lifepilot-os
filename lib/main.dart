...
final Map<String, Map<String, String>> localizedValues = {
  'ar': {
    ...
    'promptHint': 'اسأل الذكاء الاصطناعي أو اطلب توليد برنامج أو فيديو...',
  ...
  'en': {
    ...
    'promptHint': 'Ask AI or request app / video generation...',
    'newChat': 'New Chat',
...
class _GeminiChatScreenState extends State<GeminiChatScreen> {
  ...
  void _sendMessage() async {
    ...
    // محاكاة معالجة ذكية وعميقة تفهم السياق وتتفاعل مع الأسئلة بدقة
    ...
    if (lowerText.contains('مصاريف') || lowerText.contains('إيرادات') || lowerText.contains('شركة') || lowerText.contains('برنامج') || lowerText.contains('كشف')) {
      aiResponse = "أهلاً بك يا قائد. لقد قمت بتحليل طلبك المالي بدقة، وتم تصميم وإنشاء برنامج إيرادات الشركات والمصاريف اليومية والشهرية خصيصاً لك. يمكنك الضغط على الزر أدناه لتشغيله بكامل مميزاته التفاعلية.";
      isAppGenerated = true;
    } else if (lowerText.contains('فيديو') || lowerText.contains('كوميدي') || lowerText.contains('سينما') || lowerText.contains('مشهد')) {
      aiResponse = "لقد قمت بتوليد السيناريو الكوميدي والإطارات البصرية بدقة 4K. الفيديو جاهز الآن للمعاينة الفورية مع المؤثرات الصوتية والدرامية.";
      isVideoGenerated = true;
    } else if (lowerText.contains('لماذا') || lowerText.contains('كيف') || lowerText.contains('اين') || lowerText.contains('أين')) {
      aiResponse = "سؤال ممتاز يا قائد! أنا محرك Gemini الذكي داخل منصة LifePilot OS. كلما طلبت مني تصميم برنامج (مثل المصاريف أو الإيرادات) أو توليد محتوى (مثل الفيديوهات)، أقوم ببنائه وفوريّاً أعطيك زراً تفاعلياً لتشغيله. جرب أن تكتب لي الآن: 'اريد برنامج مصاريف وإيرادات' أو 'اصنع لي فيديو كوميدي'!";
    } else {
      aiResponse = "تمت دراسة طلبك («$text») عبر الشبكات العصبية. لقد جهزت لك الهيكل المطلوب، ويمكنك الاستمرار في توجيهي بأي تفاصيل إضافية لتطويره فوراً.";
    }
    ...
    setState(() {
      ...
      _messages.add({
        ...
        'hasVideoButton': isVideoGenerated,
      });
    });
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(content: Text('▶️ جاري تشغيل الفيديو الكوميدي المولّد بالذكاء الاصطناعي...')),
                                        );
                                      },
                                      child: const CircleAvatar(
                                        backgroundColor: Colors.black87,
                                        radius: 26,
                                        child: Icon(Icons.play_arrow, color: Colors.greenAccent, size: 32),
                                      ),
                                    ),
                                  ),
                                ),
