    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF4F46E5), // لون بنفسجي عالمي عصري (Indigo)
          brightness: Brightness.light,
        ),
        useMaterial3: true,
        fontFamily: 'Cairo',
      ),
      home: const WelcomeAuthScreen(), // الشاشة الأولى المتميزة (تسجيل دخول أو زائر)
    );
  }
}
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Spacer(),
                // أيقونة مميزة تعبر عن التطبيق العالمي
                Container(
                  ...
                  child: OutlinedButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const MainNavigationScreen(isGuest: true),
                        ),
                      );
                    },
                    child: const Text(
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> screens = [
      NewPhonesScreen(currentLanguage: _currentLanguage, languages: _languages, onLangChanged: (val) => setState(() => _currentLanguage = val!)),
...
// ==========================================
// القسم الأول: الهواتف الجديدة (سحابي مجاني بتصميم عالمي)
// ==========================================
...
// ==========================================
// القسم الثاني: سوق الهواتف المستعملة (بنظام 1 دولار لفتح التواصل)
// ==========================================
