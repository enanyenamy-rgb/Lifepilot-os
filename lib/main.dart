...
class AppState extends ChangeNotifier {
  ...
  // قاعدة البيانات الموسعة والشاملة لأحدث إصدارات الهواتف العالمية لعام 2026
  ...
  // دعم اللغات بالكامل (اللغة الافتراضية هي الإنجليزية حصراً بدون تداخل)
        ...
        children: [
          ...
          Expanded(
            child: filteredPhones.isEmpty
                ? const Center(
                    child: Text(
                      'No matching phone found. Try searching for "S26 Ultra", "iPhone 17", or "Samsung".',
