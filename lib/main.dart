...
// 1. شاشة تسجيل الدخول (مع ربط المالك حصرياً ببريدك الإلكتروني)
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleLogin() {
    ...
    Timer(const Duration(seconds: 2), () {
      ...
      // التحقق حصرياً من بريدك الإلكتروني الشخصي كمالك للتطبيق
      bool isOwner = (email == "enanyenamy@gmail.com");
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: "Commander Email (Enter your email)",
...
// 2. الشاشة الرئيسية مع دعم شارة المالك الذهبية وتعدد اللغات
