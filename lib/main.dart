...
class HomeScreen extends StatelessWidget {
  ...
  // نافذة تفاعلية مطورة مع الأوامر السريعة وأزرار التصدير الآمنة
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text("Result copied successfully!"), duration: Duration(seconds: 1)),
                            );
                          },
                        ),
                        IconButton(
                          ...
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text("Sharing hub ready!"), duration: Duration(seconds: 1)),
                            );
                          },
                        ),
                      ],
