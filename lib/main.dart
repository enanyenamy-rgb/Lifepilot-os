          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('حالة النظام والأداء', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const Divider(),
                  const SizedBox(height: 10),
                  Row(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Text('متصل وجاهز ✅', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ],
              ),
    ...
    return ListView(
      ...
      children: const [
        ...
        ListTile(
          ...
          subtitle: Text('LifePilot OS - Enterprise Solution v1.0'),
        ),
      ],
    );
  }
