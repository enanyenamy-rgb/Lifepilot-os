...
class HomeScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Grid Engines (4 الأيقونات كاملة)
              Expanded(
  ...
  void _showEngineLoadingPopup(BuildContext context, String engineName) {
    ValueNotifier<String> statusNotifier = ValueNotifier<String>("Starting $engineName AI Engine...");
    ValueNotifier<bool> isLoadingNotifier = ValueNotifier<bool>(true);

    // مؤقت ذكي لإنهاء التحميل بعد ثانيتين تلقائياً
    Timer(const Duration(seconds: 2), () {
      if (context.mounted) {
        statusNotifier.value = "$engineName is Ready & Active!";
