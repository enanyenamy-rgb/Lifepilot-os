                          ...
                          Future.delayed(const Duration(milliseconds: 800), () {
                            setStateModal(() {
                              ...
                              if (userPrompt.contains('مصاريف') || userPrompt.contains('finance') || userPrompt.contains('money')) {
                                outputText = "📊 **برنامج إدارة المصاريف اليومية:**\n• تسجيل الإيرادات والمصروفات.\n• حساب صافي الرصيد اليومي.\n• إصدار تقارير مالية مبسطة.";
                              } else {
                                outputText = "✨ **الاستجابة الفورية من محرك ($engineTitle):**\nتم تنفيذ طلبك بنجاح بناءً على الأمر:\n«$userPrompt»\n\nحالة المهمة: تمت المعالجة بامتياز!";
                              }
                            });
                          });
                        },
