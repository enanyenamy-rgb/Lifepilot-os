...
// 1. شاشة تسجيل الدخول (مع تأمين كامل للإيميل وكلمة المرور الخاصة بك)
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleLogin() {
    ...
    Timer(const Duration(seconds: 2), () {
      ...
      // التحقق الأمني: بريدك الإلكتروني وكلمة المرور السرية الخاصة بك حصرياً
      bool isOwner = (email == "enanyenamy@gmail.com" && password == "Ahmed_238080@");

      // إذا كتب بريدك ولكن بكلمة مرور خاطئة
