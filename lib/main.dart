...
// ==========================================
// شاشة الترحيب الخارجية (مع 25 لغة عالمية)
// ==========================================
...
// ==========================================
// التطبيق الرئيسي (مع إمكانية تغيير اللغة وزر الخروج داخل التطبيق)
// ==========================================
...
// ==========================================
// موسوعة الهواتف (مع محرك البحث الذكي وزر الخروج واللغات الـ 25)
// ==========================================
...
class _NewPhonesDatabaseScreenState extends State<NewPhonesDatabaseScreen> {
  ...
  final List<Map<String, dynamic>> phonesDatabase = [
    ...
    },
    {
      ...
      'release': 'فبراير 2024',
      'price': '\$999',
      'screen': '6.73 بوصة AMOLED (120Hz)',
      'processor': 'Snapdragon 8 Gen 3',
      'camera': '50 م.ب Leica',
      'battery': '5300 ميللي أمبير',
      'color': Colors.deepOrange,
    },
  ];

  // قائمة الـ 25 لغة داخل التطبيق
  final List<Map<String, String>> languagesList = [
    {'code': 'ar', 'name': 'العربية (Arabic)'},
    {'code': 'en', 'name': 'English (الإنجليزية)'},
    {'code': 'fr', 'name': 'Français (الفرنسية)'},
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.currentLang == 'ar' ? 'موسوعة الهواتف العالمية' : 'Global Phones Database', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
      ...
      body: Column(
        children: [
          // شريط البحث الذكي (Smart Search)
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: TextField(
              onChanged: (value) => setState(() => searchQuery = value),
              decoration: InputDecoration(
                hintText: widget.currentLang == 'ar' ? 'ابحث عن أي هاتف أو ماركة...' : 'Search any phone or brand...',
