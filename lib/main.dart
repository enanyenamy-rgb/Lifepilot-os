...
class LifePilotApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // نبدأ بشاشة تسجيل الدخول أولاً
      home: const LoginScreen(),
    );
  }
}

// 1. شاشة تسجيل الدخول والترحيب الاحترافية
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleLogin() {
    ...
    // محاكاة الاتصال بقاعدة البيانات وسرعة المصادقة
    Timer(const Duration(seconds: 2), () {
      setState(() {
        _isLoading = false;
      });

      // الانتقال إلى الشاشة الرئيسية للتطبيق (HomeScreen)
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // شعار أو أيقونة الهوية البصرية للتطبيق
                Container(
...
// 2. الشاشة الرئيسية للتطبيق (التي جمعنا فيها كل المحركات واللغات والشخصيات)
