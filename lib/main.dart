            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.smartphone_rounded, size: 70, color: Colors.white),
                ),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            ...
            selectedIcon: const Icon(Icons.cloud, color: Color(0xFF6366F1), size: 24),
            label: _currentLang == 'ar' ? 'الهواتف الجديدة' : 'New Phones',
          ),
          NavigationDestination(
            icon: const Icon(Icons.storefront_outlined, size: 22),
            selectedIcon: const Icon(Icons.storefront, color: Color(0xFF6366F1), size: 24),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(isDarkMode ? Icons.wb_sunny : Icons.nightlight_round, size: 20),
            onPressed: onToggleTheme,
          ),
      ...
      body: ListView(
        ...
        children: [
          Material(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.cloud_download_rounded, color: Colors.white, size: 32),
          ...
          _buildPhoneCard('Honor X9d', 'Snapdragon 6 Gen 1 | 5800mAh', '\$400', Icons.local_fire_department),
        ],
      ),
    );
  }
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.security, color: Colors.amber.shade700, size: 28),
