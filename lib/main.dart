...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool _rememberMe = false; // متغير حالة خانة تذكرني
  ...
  void _handleLogin() {
    ...
    Timer(const Duration(seconds: 2), () {
      ...
      if (isOwner) {
        if (_rememberMe) {
          // هنا سيتم حفظ حالة التذكر مستقبلاً عند ربط التخزين المحلي
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("👑 Auto-Login Enabled: Credentials Saved!"),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // خانة الاختيار "تذكرني" (Remember Me Checkbox)
                Row(
                  children: [
                    SizedBox(
                      height: 24,
