...
final Map<String, Map<String, String>> localizedValues = {
  'ar': {
    ...
    'aiGeneratorTitle': 'مولد الذكاء الاصطناعي',
    'promptHint': 'اكتب أوامرك هنا (مثلاً: تصميم برنامج مصاريف)...',
    'generateBtn': 'توليد المحتوى',
    'resultTitle': 'النتيجة الذكية:',
    'close': 'إغلاق',
  },
  'en': {
    ...
    'aiGeneratorTitle': 'AI Generator Studio',
    'promptHint': 'Type your prompt here (e.g. Expense app)...',
    'generateBtn': 'Generate Content',
    'resultTitle': 'Smart Output:',
    'close': 'Close',
  },
  'es': {
    ...
    'aiGeneratorTitle': 'Estudio Generador de IA',
  ...
  'fr': {
    ...
    'aiGeneratorTitle': 'Studio Générateur IA',
  ...
  'de': {
    ...
    'aiGeneratorTitle': 'KI-Generator Studio',
  ...
  'pt': {
    ...
    'aiGeneratorTitle': 'Estúdio Gerador de IA',
    'promptHint': 'Digite seu comando aqui...',
    'generateBtn': 'Gerar Conteúdo',
  ...
  'it': {
    ...
    'aiGeneratorTitle': 'Studio Generatore IA',
    'promptHint': 'Digita il tuo comando qui...',
    'generateBtn': 'Genera Contenuto',
    'resultTitle': 'Risultato Generato:',
    'close': 'Chiudi',
  },
  'tr': {
    ...
    'aiGeneratorTitle': 'Yapay Zeka Üretici',
    'promptHint': 'Komutunuzu buraya yazın...',
    'generateBtn': 'İçerik Üret',
    'resultTitle': 'Üretilen Sonuç:',
    'close': 'Kapat',
  },
  'hi': {
    ...
    'aiGeneratorTitle': 'एआई जेनरेटर स्टूडियो',
  ...
  'id': {
    ...
    'aiGeneratorTitle': 'Studio Pembuat AI',
    'promptHint': 'Ketik perintah Anda di sini...',
    'generateBtn': 'Hasilkan Konten',
    'resultTitle': 'Hasil:',
    'close': 'Tutup',
  },
  'vi': {
    ...
    'aiGeneratorTitle': 'Studio Tạo AI',
  ...
  'pl': {
    ...
    'aiGeneratorTitle': 'Studio Generatora AI',
  ...
  'he': {
    ...
    'aiGeneratorTitle': 'מחולל בינה מלאכותית',
    'promptHint': 'הקלד את הפקודה שלך כאן...',
    'generateBtn': 'צור תוכן',
    'resultTitle': 'תוצאה:',
    'close': 'סגור',
  },
  'ro': {
    ...
    'aiGeneratorTitle': 'Studio Generator AI',
    'promptHint': 'Introduceți comanda aici...',
    'generateBtn': 'Generează',
  ...
  'hu': {
    ...
    'aiGeneratorTitle': 'AI Generátor Stúdió',
  ...
  'cs': {
    ...
    'aiGeneratorTitle': 'AI Generátor Studio',
  ...
  'th': {
    ...
    'aiGeneratorTitle': 'สตูดิโอสร้าง AI',
    'promptHint': 'พิมพ์คำสั่งของคุณที่นี่...',
    'generateBtn': 'สร้างเนื้อหา',
    'resultTitle': 'ผลลัพธ์:',
    'close': 'ปิด',
  },
};
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          String userPrompt = promptController.text.trim();
                          ...
                          // معالجة ذكية للأمر المدخل
                          Future.delayed(const Duration(seconds: 1), () {
                            setStateModal(() {
                              isLoading = false;
                              if (userPrompt.contains('مصاريف') || userPrompt.contains('finance') || userPrompt.contains('money')) {
                                outputText = "📊 **برنامج إدارة المصاريف اليومية الذكي:**\n• تسجيل الدخل والمصروفات.\n• تقارير يومية وشهرية تفصيلية.\n• تنبيهات عند تجاوز الميزانية.";
                              } else {
                                outputText = "✨ **الاستجابة الذكية لـ ($engineTitle):**\nلقد تم تحليل طلبك بنجاح:\n\"$userPrompt\"\n\nتم تنفيذ المهمة وتوليد النتيجة بأعلى كفاءة!";
                              }
                            });
                          });
                        },
