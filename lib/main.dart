...
// قاموس الترجمة الموحد والشامل لجميع الـ 25 لغة داخلياً وخارجياً
String getAppText(String langCode, String key) {
  ...
  // دعم ديناميكي كامل؛ إن لم تتوفر ترجمة حرفية للغة تُعرض الإنجليزية كمرجع آمن
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            ...
            label: getAppText(widget.currentLang, 'dbTitle'),
          ),
          NavigationDestination(
            icon: const Icon(Icons.storefront_outlined),
            selectedIcon: const Icon(Icons.storefront, color: Color(0xFF1E3A8A)),
            label: getAppText(widget.currentLang, 'marketTitle'),
          ),
        ],
      ),
    );
