...
// نظام الترجمة الشامل لجميع الـ 25 لغة مع دعم اللغة الإنجليزية كاحتياطي افتراضي
String getAppText(String langCode, String key) {
  ...
  // إذا كانت اللغة المحددة غير موجودة في القاموس، يتم عرض الترجمة الإنجليزية تلقائياً لضمان عدم ظهور أخطاء
