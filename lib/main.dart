...
// 1. شاشة تسجيل الدخول المتوافقة مع أندرويد وآيفون
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Cross-Platform AI Ecosystem (iOS & Android)",
...
// 2. الشاشة الرئيسية لمتعدد المنصات (iOS & Android)
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isArabic ? "جاهز للعمل على iOS & Android" : "Ready for iOS & Android",
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text("Interface Language:", style: TextStyle(color: Colors.white70, fontSize: 12)),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        isArabic 
                          ? "LifePilot OS - يعمل بكفاءة على جميع الأجهزة ($_currentLanguage)"
                          : "LifePilot OS - Optimized for iOS & Android ($_currentLanguage)",
