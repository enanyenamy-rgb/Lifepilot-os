...
class HomeScreen extends StatelessWidget {
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        isArabic 
                          ? "مرحباً بك في LifePilot OS - مركزك العالمي ($currentLanguage)"
                          : "Welcome to LifePilot OS - Your AI Hub ($currentLanguage)",
  ...
  Widget _buildEngineCard(BuildContext context, {required String title, required IconData icon, required Color color}) {
    return GestureDetector(
      onTap: () {
        _showSafeDialog(context, title, color);
      },
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
  ...
  void _showSafeDialog(BuildContext context, String engineName, Color themeColor) {
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Command $engineName:", style: const TextStyle(color: Colors.white70, fontSize: 13)),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                outputNotifier.value = "Processing request...";

                Timer(const Duration(seconds: 2), () {
                  outputNotifier.value = "Successfully generated for: '$userInput'\n[Language]: $currentLanguage 🚀";
