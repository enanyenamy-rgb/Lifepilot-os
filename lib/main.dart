...
// ==========================================
// شاشة الترحيب والدخول الفاخرة (تصميم عالمي)
// ==========================================
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.phone_iphone_rounded, size: 80, color: Colors.white),
                ),
                ...
                const Text(
                  'المتجر الذكي الأول عالمياً للموبايلات الجديدة والمستعملة',
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            ...
            selectedIcon: const Icon(Icons.cloud_rounded, color: Color(0xFF4F46E5), size: 26),
            label: _currentLang == 'ar' ? 'الهواتف الجديدة' : 'New Phones',
          ),
          NavigationDestination(
            icon: const Icon(Icons.storefront_outlined, size: 24),
            selectedIcon: const Icon(Icons.storefront_rounded, color: Color(0xFF4F46E5), size: 26),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(isDarkMode ? Icons.wb_sunny_rounded : Icons.nightlight_round, size: 20),
            onPressed: onToggleTheme,
          ),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(22),
                  boxShadow: [BoxShadow(color: const Color(0xFF4F46E5).withOpacity(0.4), blurRadius: 15, offset: const Offset(0, 8))],
                ),
                child: Row(
                  children: [
                    Container(
  ...
  Widget _buildPhoneCard(String name, String specs, String price, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(22),
        boxShadow: [BoxShadow(color: Colors.black.withOpacity(isDarkMode ? 0.2 : 0.05), blurRadius: 15, offset: const Offset(0, 6))],
      ...
      child: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [const Color(0xFF4F46E5).withOpacity(0.2), const Color(0xFF6366F1).withOpacity(0.1)]),
              borderRadius: BorderRadius.circular(18),
            ),
            child: Icon(icon, color: const Color(0xFF4F46E5), size: 30),
          ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.security_rounded, color: Colors.amber.shade700, size: 24),
                ),
