...
// ==========================================
// شاشة الترحيب الخارجية (محدثة لتكون StatefulWidget لتحديث الواجهة فوراً)
// ==========================================
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: PopupMenuButton<String>(
                        ...
                        onSelected: (newLang) {
                          setState(() {
                            _activeLang = newLang; // تحديث الواجهة الخارجية فوراً
                          });
                        },
                        itemBuilder: (context) {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(getAppTest(currentLang, 'unlockBtn')),
              ),
            ),
          ],
        ),
