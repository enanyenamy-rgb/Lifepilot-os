...
// ذاكرة عامة لحفظ تاريخ المحادثات والبرامج المولدة لكل العملاء
...
// شاشة المحادثة الديناميكية بأسلوب جيمناي (Gemini Chat Stream)
...
class _GeminiChatScreenState extends State<GeminiChatScreen> {
  ...
  void _sendMessage() async {
    ...
    // محاكاة استجابة ذكاء اصطناعي تفاعلية وعميقة
    ...
    // حفظ في الأرشيف العام (Vault) لتكون مسجلة لأي عميل
...
// شاشة أرشيف المحادثات والبرامج المولدة لكل العملاء (Vault)
...
// شاشة تطبيق المصاريف المُولّد تفاعلياً
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: const Color(0xFF8AB4F8).opacity30 ?? const Color(0xFF8AB4F8)),
              ),
              child: Row(
