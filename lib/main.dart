              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.5), blurRadius: 30, spreadRadius: 8)],
                  ),
                  child: const Icon(Icons.public_rounded, size: 85, color: Colors.white),
                ),
                const SizedBox(height: 32),
                const Text(
                  'AI Phone Store Global',
                  style: TextStyle(fontSize: 34, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 1.5),
                ),
                const SizedBox(height: 12),
                const Text(
                  'موسوعة الهواتف العالمية الشاملة • صور حقيقية ومواصفات فورية',
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    child: const Text('الدخول كزائر (تصفح الموسوعة)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('تسجيل الدخول العالمي', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Text('أدخل بريدك الإلكتروني للمتابعة', style: TextStyle(color: Colors.grey, fontSize: 14)),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            ...
            label: _currentLang == 'ar' ? 'موسوعة الهواتف' : 'Global Phones',
          ),
          NavigationDestination(
...
// ==========================================
// القسم الأول: موسوعة الهواتف العالمية (صور حقيقية وخصائص كاملة)
// ==========================================
class NewPhonesScreen extends StatelessWidget {
  ...
  // قاعدة بيانات عالمية ضخمة تحتوي على صور حقيقية من الإنترنت ومواصفات شاملة لجميع الهواتف
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    currentLang == 'ar'
                        ? '🌍 متصل بالسحابة العالمية: عرض صور حقيقية ومواصفات لجميع هواتف العالم بدون اشتراك.'
                        : '🌍 Global Cloud Connected: Real photos and specs for all world phones free.',
          ...
          const SizedBox(height: 20),
          // عرض جميع الهواتف من القائمة العالمية مع الصور الحقيقية
  ...
  Widget _buildGlobalPhoneCard(String name, String brand, String price, String specs, String imageUrl) {
    return Container(
      ...
      child: Row(
        children: [
          // صورة الهاتف الحقيقية من السحابة مع حواف دائرية فاخرة
          ClipRRect(
