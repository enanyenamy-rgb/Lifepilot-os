...
class AppState extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> translations = {
    'en': { 'title': 'Ai Phone Store Global', 'login': 'Secure Login', 'email': 'Email Address', 'password': 'Password', 'guest': 'Explore as Guest', 'newPhones': 'Global Catalogs', 'usedMarket': 'Secure Used Market', 'selectLang': 'Select Language', 'sellPhone': 'List Your Phone for Sale', 'searchHint': 'Search any phone (e.g. Oppo, S26 Ultra)...', 'phoneName': 'Phone Model Name', 'price': 'Price (\$)', 'details': 'Condition & Specifications', 'phoneNum': 'Phone Number (Hidden for Privacy)', 'whatsappNum': 'WhatsApp Number', 'idProof': 'ID Document / National ID Number', 'submit': 'Publish Listing', 'unlockBtn': 'Unlock Seller Contact (\$1 Fee)', 'unlockedLabel': 'Seller Contact Unlocked:' },
    'ar': { 'title': 'متجر الهواتف العالمي الذكي', 'login': 'تسجيل الدخول الآمن', 'email': 'البريد الإلكتروني', 'password': 'كلمة المرور', 'guest': 'تصفح كزائر', 'newPhones': 'الكتالوجات العالمية', 'usedMarket': 'سوق المستعمل الآمن', 'selectLang': 'اختر لغة التطبيق', 'sellPhone': 'إضافة هاتفك للبيع', 'searchHint': 'ابحث عن أي هاتف (مثل أوبو، S26 Ultra)...', 'phoneName': 'اسم موديل الهاتف', 'price': 'السعر (\$)', 'details': 'تفاصيل الحالة والمواصفات', 'phoneNum': 'رقم الهاتف (يُخفى لحماية الخصوصية)', 'whatsappNum': 'رقم الواتساب للتواصل', 'idProof': 'رقم الهوية أو مستند التحقق (اختياري)', 'submit': 'نشر الإعلان في السوق', 'unlockBtn': 'إظهار رقم وبطاقة البائع (رسوم 1 دولار)', 'unlockedLabel': 'تم فتح وسيلة الاتصال للبائع:' },
