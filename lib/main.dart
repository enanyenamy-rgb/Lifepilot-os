    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(isArabic ? 'الأقسام النشطة (اضغط لأي قسم)' : 'Active Hubs', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
      ...
      body: ListView(
        ...
        children: [
          ...
          const ListTile(
            ...
            subtitle: Text('LifePilot OS - Fully Interactive v3.2'),
          ),
        ],
      ),
    );
