...
// قاموس الترجمة النقي والمستقر لجميع الـ 25 لغة
String getAppText(String langCode, String key) {
  Map<String, Map<String, String>> dictionary = {
    'ar': {
      ...
      'marketBanner': 'ادفع 1 دولار فقط لكشف كافة وسائل التواصل الخاصة بالبائع.',
      'unlockBtn': 'ادفع 1 دولار لكشف رقم البائع والواتساب',
    ...
    'fr': {
      ...
      'priceLabel': 'Prix:',
      'closeSpecs': 'Fermer',
      'marketBanner': 'Payez 1 euro pour révéler le contact.',
      'unlockBtn': 'Payer 1 euro',
      'exitTitle': 'Quitter',
    ...
    'es': {
      ...
      'priceLabel': 'Precio:',
      'closeSpecs': 'Cerrar',
      'marketBanner': 'Pague 1 dólar para revelar el contacto.',
      'unlockBtn': 'Pagar 1 dólar',
      'exitTitle': 'Salir',
      'exitMsg': '¿Desea salir?',
      'cancel': 'Cancelar',
      'confirmExit': 'Salir',
    ...
    'de': {
      ...
      'marketBanner': 'Zahlen Sie 1 Dollar für Kontakt.',
      'unlockBtn': 'Zahlen Sie 1 Dollar',
      'exitTitle': 'Beenden',
    ...
    'it': {
      ...
      'priceLabel': 'Prezzo:',
      'closeSpecs': 'Chiudi',
      'marketBanner': 'Paga 1 dollaro per il contatto.',
      'unlockBtn': 'Paga 1 dollaro',
      'exitTitle': 'Esci',
      'exitMsg': 'Vuoi uscire?',
      'cancel': 'Annulla',
      'confirmExit': 'Esci',
    ...
    'pt': {
      ...
      'priceLabel': 'Preço:',
      'closeSpecs': 'Fechar',
      'marketBanner': 'Pague 1 dólar pelo contato.',
      'unlockBtn': 'Pagar 1 dólar',
      'exitTitle': 'Sair',
      'exitMsg': 'Deseja sair?',
      'cancel': 'Cancelar',
    ...
    'hi': {
      ...
      'priceLabel': 'मूल्य:',
      'closeSpecs': 'बंद करें',
      'marketBanner': 'संपर्क देखने کے लिए भुगतान करें।',
      'unlockBtn': 'भुगतान करें',
    ...
    'tr': {
      ...
      'priceLabel': 'Fiyat:',
      'closeSpecs': 'Kapat',
      'marketBanner': 'İletişim için ödeme yapın.',
      'unlockBtn': 'Ödeme Yap',
      'exitTitle': 'Çıkış',
...
// ==========================================
// شاشة الترحيب الخارجية (محدثة وتعمل مع كل اللغات)
// ==========================================
...
class _WelcomeAuthScreenState extends State<WelcomeAuthScreen> {
  ...
  void initState() {
    super.initState();
    _activeLang = widget.initialLang;
  }
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: IconButton(
                        icon: Icon(widget.isDarkMode ? Icons.wb_sunny_rounded : Icons.nightlight_round, color: Colors.white, size: 20),
                      ...
                      child: PopupMenuButton<String>(
                        ...
                        itemBuilder: (context) {
                          return globalLanguagesList.map((lang) {
                            bool isSelected = _activeLang == lang['code'];
                ...
                Text(
                  getAppText(_activeLang, 'subtitle'),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => MainNavigationScreen(onToggleTheme: widget.onToggleTheme, isDarkMode: widget.isDarkMode, initialLang: _activeLang)),
                      );
                    },
                    child: Text(getAppText(_activeLang, 'signin'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    child: Text(getAppText(_activeLang, 'guest'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ),
                ),
