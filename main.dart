          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isArabic ? 'نظام متكامل يولد لك الأفكار، الردود، والصور والتصميمات الهندسية والمرئية فوراً.' : 'An OS generating ideas, answers, and visual designs instantly.',
...
class _DynamicChatScreenState extends State<DynamicChatScreen> {
  ...
  void _sendMessage() {
    ...
    setState(() {
      _messages.add({'sender': 'user', 'text': userQuery, 'hasImage': false});
      _controller.clear();
    });
    ...
    // محرك ردود وتصميمات مرئية حية حسب الطلب
    Future.delayed(const Duration(milliseconds: 800), () {
      ...
      if (widget.hubTitle.contains('الديكور')) {
        aiResponse = '🌟 **التصميم الهندسي والمرئي المقترح لطلبك:**\n\n'
            '• **التخطيط المساحي:** تم هندسة الفراغ بدقة ليتناسب مع طلبك.\n'
            '• **تنسيق الألوان والأثاث:** دمج مودرن راقي مع إضاءة محيطية متطورة.\n'
            '📸 *تم توليد وتصميم الصورة الهندسية أدناه خصيصاً لتتخيل شكل المكان:*';
        ...
        aiResponse = '🩺 **التقرير الطبي الإرشادي والتوضيحي:**\n\n'
            ...
            '📊 *إليك رسم بياني وتوضيحي طبي مبسط للحالة:*';
        ...
        aiResponse = '👗 **استشارات الموضة وتصميم الأزياء:**\n\n'
            ...
            '🎨 *تم تصميم وتوليد العرض المرئي للإطلالة المقترحة أدناه:*';
      } else {
              ...
              child: _messages.isEmpty
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('اطرح طلبك في ${widget.hubTitle}\nوسأقوم بالرد وتوليد التصميم المرئي فوراً ✨', textAlign: TextAlign.center, style: const TextStyle(fontSize: 15, color: Colors.grey, height: 1.4, fontWeight: FontWeight.w500)),
                          ],
                        ),
                      ),
                    )
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool hasImage = _messages[index]['hasImage'] ?? false;
                        return Container(
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          const Icon(Icons.image, size: 50, color: Color(0xFF6366F1)),
                                          Positioned(
                                            bottom: 8,
                                            child: Container(
                                              ...
                                              child: const Text(
                                                '✨ تصميم مرئي مولد بالذكاء الاصطناعي',
      ...
      body: ListView(
        ...
        children: [
          ...
          const ListTile(
            ...
            subtitle: Text('LifePilot OS - Visual AI Generator v5.0'),
          ),
        ],
      ),
    );
